...
if __name__=="__main__":
    ...
    for channel_name in channel_name_lst:
        ...
        #  var_dic['m4l'].append(channel_name + "m4l")
        var_dic['lepton_eta'].append(channel_name+"_fwdele_pt")
        var_dic['lepton_eta'].append(channel_name+"_fwdele_eta")
